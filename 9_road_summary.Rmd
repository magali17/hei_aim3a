...
design_levels <- c("Balanced", "Random Segments", #"Unbalanced", 
                                         "Random Clusters", "Sensible Clusters", "Unsensible Clusters", "Road Type")
...
temp <- data.frame(version=c("All Data Stationary\nExposure Model"),
                   ...
                   design = NA,
                   visits = "4 visits per location") #%>% mutate(design = factor(design, levels = c(design_levels, NA)))
