...
onroad_predictions <- readRDS(file.path(dt_path, "UK Predictions", "onroad_predictions.rda"))
...
# --> drop unbalanced non-spatially dependant sampling 
...
# --> all-data stationary P-TRAK results
