...
# VARIABLES
##################################################################################################
main_road_types <-"no_highways" # "all_road_types" #
main_bg <- "hr1_pct5"
...
road_dt_no_hwy %>%
  ...
  kable(caption = "distribution of 1-sec measures per hour...these are NOT used to calculate hourly background", 
        digits = 0) %>%
  kable_styling()
