...
keep_main_results <- function(dt, 
                             keep_visits = c(main_visits, alt_visits),
                             designs_to_keep = main_designs,
                             versions_to_keep = main_versions,
                             visits_to_keep=main_visits,
                             cluster_to_keep = main_cluster
...
########################################################################################
# plot concentrations
plot_concentrations <- function(dt){
...
geom_hline(yintercept = ref_prediction_distribution$median, alpha=0.8, col=ref_model_col, linetype=2) +
