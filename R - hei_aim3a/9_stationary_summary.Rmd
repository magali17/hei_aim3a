...
extended_models_hei <- beta_summary_plot(dt=model_coefs_extended, true_betas.=true_betas_extended, facet_label = "Extended Adjusted Health Model")

ggarrange(reduced_models_hei,  extended_models_hei, ncol = 1, common.legend = T, legend = "bottom") %>%
  annotate_figure(left = "Health Point Estimate",
                  right = "Health Point Estimate (% Different from Reference)", 
                  bottom = "Design")
ggsave(file.path(image_path, "HEI Report", "beta_boxplots_main_reduced.png"), width = 12, height = 10)

# beta_summary_plot(dt=model_coefs, true_betas.=true_betas, facet_label = "") + 
#   labs(y="Health Point Estimate")
# 
# ggsave(file.path(image_path, "HEI Report", "beta_boxplots_main_reduced.png"), width = 12, height = 5)
# 
# 
# beta_summary_plot(dt=model_coefs_extended, true_betas.=true_betas_extended, facet_label = "Extended Adjusted Health Model") + 
#   labs(y="Health Point Estimate")
# ggsave(file.path(image_path, "HEI Report", "Appendix", "beta_boxplots_extended.png"), width = 12, height = 5)
