...
ggsave(file.path(image_path, "HEI Report", "Appendix", "r2_sensitivity.png"), width = 12, height = 12)
...
extended_models <- beta_summary_plot(dt=model_coefs_extended, true_betas.=true_betas_extended, facet_label = "Main Health Model")

ggarrange(reduced_models,  extended_models, ncol = 2, common.legend = T, legend = "bottom") %>%
...
reduced_models_hei <- beta_summary_plot(dt=model_coefs, true_betas.=true_betas, facet_label = "Main Health Model")
extended_models_hei <- beta_summary_plot(dt=model_coefs_extended, true_betas.=true_betas_extended, facet_label = "Extended Health Model")
