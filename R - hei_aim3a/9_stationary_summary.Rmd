...
ggsave(file.path(image_path, "other", "presentation", "r2_large_text.png"), width = 12, height = 8)
...
### for poster
```{r}
temp <- data.frame(version= 2.5,# c("Bus Adj"),
...
ggsave(file.path(image_path, "other", "presentation", "beta_boxplots_main_large_text.png"), width = 12, height = 8)
