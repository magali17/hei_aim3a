...
# # Capture the citation information
# lmtest_citation <- toBibtex(citation("lmtest"))
# # Export the citation to a .bib file
# write(lmtest_citation, file = "Output/v3_20230321/lmtest_citation.bib")
