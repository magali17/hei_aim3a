...
# r2_label <- filter(campaign_descriptions, grepl("Total", variable), design=="All Data") %>%
#   mutate(MSE_based_R2 = round(MSE_based_R2, 2))

campaign_descriptions %>%
  mutate(#design = ifelse(version=="All Data", "", as.character(design)),
         #design = factor(design, levels = levels(c("", campaign_descriptions$design)))
         ) %>%
  ...
  #geom_label(dta=r2_label, aes(x=1, label=MSE_based_R2, y=MSE_based_R2)) + 
  
  labs(y = "Exposure Model R2", # MSE-Based R2
       x = "Design")
...
# ggsave(file.path(image_path, "other", "poster", paste0("beta ", x, ".png")), width = 4, height = 2.5)

# })
# 
# ggarrange(plotlist = p, #common.legend = T, 
#           legend = "bottom",  
#           label.x = "Campaign", label.y = "Beta Estimate" #, #align = "hv"  
#           )
